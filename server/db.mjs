...
import {emptyState,applyCommand,hydrateState} from '../web/core/model.mjs';
...
export function openStore(path=defaultPath()){
 ...
 const read=()=>hydrateState(JSON.parse(db.prepare('SELECT data FROM state WHERE id=1').get().data));
